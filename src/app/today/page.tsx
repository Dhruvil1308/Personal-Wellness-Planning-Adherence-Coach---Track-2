...
import { AdherenceRing, AIBadge, EmptyState, SectionTitle } from "@/components/ui";
    ...
    <div className="mx-auto max-w-6xl px-5 py-7">
      <header className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight">{prettyDay(date)}</h1>
          {plan?.focus && (
          ...
          <div className="space-y-5">
            <section className="card p-5">
              <SectionTitle
                ...
                right={<AIBadge generatedBy={plan.generatedBy} />}
              />
